...
cc_ulf_child <- ggplot(
  ...
  geom_smooth(
    ...
    level = 0.95,
    alpha = 0.2      # make ribbons semi-transparent
  ) +
  scale_color_manual(
    values = c(
...
caudate_ulf_child <- ggplot(
  ...
  geom_smooth(
    ...
    se = TRUE,       # show 95% confidence ribbons
    level = 0.95,
    alpha = 0.2      # semi-transparent ribbons
  ) +
  scale_color_manual(
    values = c(
      "no_child_anaemia" = "#1f77b4",  # dark blue
...
cc_ulf_id <- ggplot(
  ...
  geom_smooth(
    ...
    level = 0.95,
    alpha = 0.2      # make ribbon light and semi-transparent
  ) +
  scale_color_manual(
    values = c("no_mat_id" = "#2E8B57", "mat_id" = "#5E35B1"),
    name = "Maternal ID Status"
...
caudate_ulf_id <- ggplot(
  ...
  geom_smooth(
    ...
    se = TRUE,         # show 95% confidence interval
    level = 0.95,
    alpha = 0.2        # light, semi-transparent ribbon
  ) +
  scale_color_manual(
    values = c("no_mat_id" = "#2E8B57", "mat_id" = "#5E35B1"),
    name = "Maternal ID Status"
